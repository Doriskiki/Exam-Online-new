  ...
  <el-container>
    ...
    <el-main>
      ...
      >
        ...
        <el-table-column align="center" prop="singleChoice" label="单选题数量">
        </el-table-column>
        ...
        <el-table-column align="center" prop="judge" label="判断题数量">
        </el-table-column>

        <el-table-column align="center" prop="shortAnswer" label="简答题数量">
        </el-table-column>
    ...
    >
      ...
      <el-card style="height: 60px;position: relative">
        <span
          style="position: absolute;font-size: 16px;font-weight: 400;top: 20px;"
          >{{ questionBankInfo[currentBankIndex].questionBank.bankName }}</span
        >
      </el-card>
      ...
      <el-card>
        <div
          ...
          @click="
            questionBankInfo[currentBankIndex].singleChoice > 0
              ? toTrainPage(3)
              : $message.warning('当前类型题库暂未收录o(╥﹏╥)o')
          "
        >
          <div class="img-btn">
        ...
        <div
          ...
          style="padding-left: 10px; padding-right: 10px;"
          @click="
            questionBankInfo[currentBankIndex].multipleChoice > 0
              ? toTrainPage(4)
              : $message.warning('当前类型题库暂未收录o(╥﹏╥)o')
          "
        >
        ...
        <div
          ...
          style="padding-left: 10px; padding-right: 10px;"
          @click="
            questionBankInfo[currentBankIndex].judge > 0
              ? toTrainPage(5)
              : $message.warning('当前类型题库暂未收录o(╥﹏╥)o')
          "
        >
...
export default {
  ...
  methods: {
    ...
    getBankInfo() {
      this.$http
        .get(this.API.getBankHaveQuestionSumByType, { params: this.queryInfo })
        .then(resp => {
      ...
      if (val === "delete") {
        this.$confirm("此操作将永久删除该题库, 是否继续?", "提示", {
          ...
          .then(() => {
            ...
            //发起删除请求
            this.$http
              .get(this.API.deleteQuestionBank, {
                params: { ids: ids.join(",") }
              })
              .then(resp => {
                if (resp.data.code === 200) {
