        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button
                        ...
                        icon="Download"
                        @click="handleExport"
                        v-hasPermi="['exam:category:export']"
                >导出
                </el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                               v-hasPermi="['exam:category:edit']">修改
                    </el-button>
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                               v-hasPermi="['exam:category:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <vxe-modal :title="title" v-model="open" width="500px" show-maximize showFooter resize>
            <el-form ref="categoryRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="排序" prop="sortOrder">
                    <el-input-number style="width: 100%;" v-model="form.sortOrder" placeholder="请输入排序"/>
                </el-form-item>
            </el-form>
            <template #footer>
...
const data = reactive({
    ...
    upload: {
        ...
        // 上传的地址
        url: baseURL + "/exam/category/importData"
    }
})
...
/** 导出按钮操作 */
const handleExport = () => {
    proxy.download('exam/category/export', {
        ...queryParams.value
...
const importTemplate = () => {
    proxy.download('exam/category/importTemplate', {}, `template_${new Date().getTime()}.xlsx`)
}

/** 导入按钮操作 */
const handleImport = () => {
    upload.value.title = "题目分类导入";
